...
public class AddConfidanceFragment extends Fragment {
    public static String TAG = "AddConfidanceFragment";
    public static AddConfidanceFragment mInstance;
    ...
    private AddConfidanceFragment() {
    }

    public static AddConfidanceFragment getInstance() {
        if (mInstance == null)
            return new AddConfidanceFragment();
        else
            return mInstance;
    }
    ...
    public void toValidityFragment() {
        ...
        getFragmentManager()
                .beginTransaction()
                .replace(R.id.flTrustPeopleContainer, validityFragment)
                .addToBackStack("")
                .commit();
    }
