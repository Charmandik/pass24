                ...
                .subscribe(new Observer<VehicleBrandResponse>() {
                    ...
                    public void onNext(VehicleBrandResponse vehicleBrandResponse) {
                        if (vehicleBrandResponse != null)
                            ...
                            else if (vehicleBrandResponse.getError() != null)
                                if (vehicleBrandResponse.getError().getCode() != null)
                                    if (vehicleBrandResponse.getError().getCode().equals("UNAUTHENTICATED"))
                                        toLogin();
                    }
