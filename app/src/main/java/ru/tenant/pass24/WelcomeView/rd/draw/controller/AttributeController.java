package ru.tenant.pass24.WelcomeView.rd.draw.controller;
...
public class AttributeController {
    ...
    private void initAnimationAttribute(@NonNull TypedArray typedArray) {
        ...
        int animationDuration = typedArray.getInt(R.styleable.PageIndicatorView_piv_animationDuration, ru.tenant.pass24.WelcomeView.rd.animation.type.BaseAnimation.DEFAULT_ANIMATION_TIME);
