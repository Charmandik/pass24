...
import ru.tenant.pass24.WelcomeView.rd.animation.type.BaseAnimation;
import ru.tenant.pass24.WelcomeView.rd.draw.data.Indicator;
import ru.tenant.pass24.WelcomeView.rd.draw.data.Orientation;
import ru.tenant.pass24.WelcomeView.rd.utils.CoordinatesUtils;

public class AnimationController {

    private ru.tenant.pass24.WelcomeView.rd.animation.controller.ValueController valueController;
    private ru.tenant.pass24.WelcomeView.rd.animation.controller.ValueController.UpdateListener listener;
    ...
    public AnimationController(@NonNull Indicator indicator, @NonNull ru.tenant.pass24.WelcomeView.rd.animation.controller.ValueController.UpdateListener listener) {
        this.valueController = new ru.tenant.pass24.WelcomeView.rd.animation.controller.ValueController(listener);
