package ru.tenant.pass24.WelcomeView.rd.draw.data;
...
public class Indicator {
    ...
    private ru.tenant.pass24.WelcomeView.rd.draw.data.RtlMode rtlMode;
    ...
    public Orientation getOrientation() {
        if (orientation == null) {
            orientation = ru.tenant.pass24.WelcomeView.rd.draw.data.Orientation.HORIZONTAL;
        }
        return orientation;
    }
    ...
    @NonNull
    public ru.tenant.pass24.WelcomeView.rd.draw.data.RtlMode getRtlMode() {
        if (rtlMode == null) {
            rtlMode = ru.tenant.pass24.WelcomeView.rd.draw.data.RtlMode.Off;
        }
        return rtlMode;
    }

    public void setRtlMode(ru.tenant.pass24.WelcomeView.rd.draw.data.RtlMode rtlMode) {
