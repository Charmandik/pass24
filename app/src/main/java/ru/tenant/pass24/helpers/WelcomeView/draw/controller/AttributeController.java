package ru.tenant.pass24.helpers.WelcomeView.draw.controller;
...
public class AttributeController {
    ...
    private void initAnimationAttribute(@NonNull TypedArray typedArray) {
        ...
        int animationDuration = typedArray.getInt(R.styleable.PageIndicatorView_piv_animationDuration, ru.tenant.pass24.helpers.WelcomeView.animation.type.BaseAnimation.DEFAULT_ANIMATION_TIME);
